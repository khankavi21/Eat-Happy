                ...
                <div id="carouselExampleFade" className="carousel slide carousel-fade " data-bs-ride="carousel" style={{ objectFit: "contain" }}>
                    <div className="carousel-inner" id="carousel">
                        ...
                        <div className="carousel-item active">
                            <img src="https://source.unsplash.com/random/1600x500/?Burger" className="d-block w-100" style={{ filter: "brightness(65%)" }} alt="Burger" />
                        </div>
                        <div className="carousel-item">
                            <img src="https://source.unsplash.com/random/1600x500/?food" className="d-block w-100" style={{ filter: "brightness(65%)" }} alt="Noodles" />
                        </div>
                        <div className="carousel-item">
                            <img src="https://source.unsplash.com/random/1600x500/?cake" className="d-block w-100" style={{ filter: "brightness(65%)" }} alt="cake" />
                        </div>
                    </div>
